...
cvar_t *cl_strafehelperEfficiency;
cvar_t *cl_strafehelperEffStyle;
cvar_t *cl_strafehelperEffWidth;
cvar_t *cl_strafehelperEffHeight;
cvar_t *cl_strafehelperEffX;
cvar_t *cl_strafehelperEffY;
cvar_t *cl_strafehelperEffBorder;
cvar_t *cl_strafehelperEffMarker;
cvar_t *cl_strafehelperEffColorMode;
cvar_t *cl_strafehelperEffColorGood;
cvar_t *cl_strafehelperEffColorMid;
cvar_t *cl_strafehelperEffColorBad;
cvar_t *cl_strafehelperEffColorBg;
cvar_t *cl_strafehelperEffColorMidpoint;
cvar_t *cl_strafehelperEffSmoothing;
cvar_t *cl_strafehelperEffHoldMs;
cvar_t *cl_strafehelperEffTextScale;
cvar_t *cl_strafehelperEffTint;
cvar_t *cl_strafehelperEffTintStrength;
...
void SH_Init(void)
{
    ...
    cl_strafehelperEffColorGood = Cvar_Get("sh_efficiency_color_good", "80 220 90 255", CVAR_ARCHIVE);
    cl_strafehelperEffColorMid = Cvar_Get("sh_efficiency_color_mid", "235 200 60 255", CVAR_ARCHIVE);
    cl_strafehelperEffColorBad = Cvar_Get("sh_efficiency_color_bad", "235 70 60 255", CVAR_ARCHIVE);
    cl_strafehelperEffColorBg = Cvar_Get("sh_efficiency_color_bg", "40 40 40 200", CVAR_ARCHIVE);
    cl_strafehelperEffColorMidpoint = Cvar_Get("sh_efficiency_color_midpoint", "0.5", CVAR_ARCHIVE);
    cl_strafehelperEffSmoothing = Cvar_Get("sh_efficiency_smoothing", "0", CVAR_ARCHIVE);
    cl_strafehelperEffHoldMs = Cvar_Get("sh_efficiency_hold_ms", "150", CVAR_ARCHIVE);
    cl_strafehelperEffTextScale = Cvar_Get("sh_efficiency_text_scale", "1", CVAR_ARCHIVE);
    cl_strafehelperEffTint = Cvar_Get("sh_efficiency_tint", "off", CVAR_ARCHIVE);
    cl_strafehelperEffTintStrength = Cvar_Get("sh_efficiency_tint_strength", "0.75", CVAR_ARCHIVE);
