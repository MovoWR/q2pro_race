...
cvar_t *sh_netwarn_ping_adaptive;  // Adjust high-ping detection to recent baseline
cvar_t *sh_netwarn_spike_ms;       // Absolute latency spike threshold, in milliseconds
cvar_t *sh_netwarn_spike_pct;      // Relative latency spike threshold, in percent
cvar_t *sh_netwarn_jitter_ms;      // Ping variation threshold, in milliseconds
/* Net Alert - on-screen network warning text. */
cvar_t *sh_netalert;              // Enable on-screen network alerts
cvar_t *sh_netalert_x;            // Alert text X position
cvar_t *sh_netalert_y;            // Alert text Y position
cvar_t *sh_netalert_color;        // Alert text color
cvar_t *sh_netalert_alpha;        // Alert text alpha/transparency
cvar_t *sh_netalert_duration_ms;  // How long alert text stays visible
cvar_t *sh_netalert_loss;         // Show alert for packet loss
cvar_t *sh_netalert_jitter;       // Show alert for unstable latency
cvar_t *sh_netalert_spike;        // Show alert for sudden latency spikes

/* Mode 1 - Lagometer: compact bar history of recent network quality. */
cvar_t *sh_lagometer_x;             // Lagometer X position
cvar_t *sh_lagometer_y;             // Lagometer Y position
cvar_t *sh_netmeter_min_ms;        // Bottom of netmeter scale, in milliseconds
cvar_t *sh_netmeter_max_ms;        // Top of netmeter scale, in milliseconds
cvar_t *sh_netmeter_adaptive;      // Auto-scale netmeter to recent samples
cvar_t *sh_lagometer_color_normal;  // Normal sample color
cvar_t *sh_lagometer_color_spike;   // Ping spike sample color
cvar_t *sh_lagometer_color_jitter;  // Ping jitter sample color
cvar_t *sh_lagometer_color_loss_s2c;// S2C loss sample color
cvar_t *sh_lagometer_color_loss_c2s;// C2S loss sample color
cvar_t *sh_lagometer_alpha;         // Normal sample alpha/transparency
cvar_t *sh_lagometer_bad_alpha;     // Bad sample alpha/transparency

/* Mode 2 - Netgraph: scrolling latency graph over recent network samples. */
cvar_t *sh_netgraph_y;             // Netgraph Y position
cvar_t *sh_netgraph_height;        // Netgraph height
cvar_t *sh_netgraph_alpha;         // Netgraph alpha/transparency
cvar_t *sh_netgraph_color_normal;  // Normal sample color
cvar_t *sh_netgraph_color_spike;   // Ping spike sample color
cvar_t *sh_netgraph_color_jitter;  // Ping jitter sample color
cvar_t *sh_netgraph_color_loss_s2c;// S2C loss sample color
cvar_t *sh_netgraph_color_loss_c2s;// C2S loss sample color
...
cvar_t *sh_histogram_color_spike;   // Pink spike sample color
cvar_t *sh_histogram_color_jitter;  // Ping jitter sample color
cvar_t *sh_histogram_color_loss_s2c;// S2C loss sample color
cvar_t *sh_histogram_color_loss_c2s;// C2S loss sample color
cvar_t *sh_histogram_alpha;         // Normal sample alpha/transparency
cvar_t *sh_histogram_bad_alpha;     // Bad sample alpha/transparency
cvar_t *sh_histogram_history;       // Number of recent samples to display
cvar_t *sh_histogram_ping;          // Draw current ping text inside histogram
...
{
    /*
     * Shared network display settings.
     *
     * sh_netmeter selects which network display mode is active:
     *   0 = off
     *   1 = lagometer
     *   2 = netgraph
     *   3 = histogram
